...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "3.5.0"
  WORKING_DIRECTORY "C:/Users/pilzm/CPPProjects/RayGame3/build/_deps/raylib-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/3.5.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "3.5.0")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/raysan5/raylib'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/pilzm/CPPProjects/RayGame3/build/_deps/raylib-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/pilzm/CPPProjects/RayGame3/build/_deps/raylib-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
